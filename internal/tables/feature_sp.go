...
{
	CreateNative(%q, Native_FeatureCount);
	CreateNative(%q, Native_FeatureFired);
	CreateNative(%q, Native_FeatureName);
}
...
`, FeaturesActiveConVar, FeatureCountNative, FeatureFiredNative, FeatureNameNative)
