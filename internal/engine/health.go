...
func PlayerMaxHealth(client int32) int32 { return healths.PlayerMaxHealth(client) }

// ClampFloat holds a value between two others.
//
//sp:library ClampFloat
...
func IsCarryingObject(client int32) bool { return healths.IsCarryingObject(client) }

// IsHealedByObject says a dispenser is doing it.
//
//sp:body IsHealedByObject
func IsHealedByObject(client int32) bool { return healths.IsHealedByObject(client) }

// IsHealedByMedic says a medic is doing it.
//
//sp:body IsHealedByMedic
func IsHealedByMedic(client int32) bool { return healths.IsHealedByMedic(client) }

// WeaponIDIsSniperRifle says the weapon is one of the rifles.
//
//sp:native WeaponID_IsSniperRifle
func WeaponIDIsSniperRifle(id Weapon) bool { return healths.WeaponIDIsSniperRifle(id) }
...
func IsCritBoosted(client int32) bool { return healths.IsCritBoosted(client) }
...
func AsFloat(cell int32) float32 { return healths.AsFloat(cell) }
...
func IsPointInRespawnRoom(position [3]float32) bool { return healths.IsPointInRespawnRoom(position) }

// IsAmmoLow says the bot is running out, which is one of the two reasons to
// stand at a dispenser.
//
//sp:body IsAmmoLow
func IsAmmoLow(client int32) bool { return healths.IsAmmoLow(client) }
