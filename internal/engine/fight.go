...
func TFBotMission(client int32) int32 { return fights.TFBotMission(client) }

// CanUsePrimaryWeapon says the sniper has his rifle back.
//
//sp:body CanUsePrimayWeapon
func CanUsePrimaryWeapon(client int32) bool { return fights.CanUsePrimaryWeapon(client) }

// ClientEyePosition is where the bot is looking from.
//
//sp:native GetClientEyePosition
func ClientEyePosition(client int32) (position [3]float32) { return fights.ClientEyePosition(client) }

// DesiredAttackRange is how close this class wants to be.
//
//sp:body GetDesiredAttackRange
func DesiredAttackRange(client int32) float32 { return fights.DesiredAttackRange(client) }
...
func SelectRandomReachableEnemy(actor int32) int32 { return fights.SelectRandomReachableEnemy(actor) }
...
func (c Combat) LastKnownArea() NavArea { return fights.LastKnownArea(c) }

// IsOnGround says the bot has its feet down.
//
//sp:method IsOnGround
func (l Locomotion) IsOnGround() bool { return fights.IsOnGround(l) }

// IsClimbingOrJumping says it is in the middle of something.
//
//sp:method IsClimbingOrJumping
func (l Locomotion) IsClimbingOrJumping() bool { return fights.IsClimbingOrJumping(l) }
...
//
//sp:method Approach
func (l Locomotion) Approach(goal [3]float32) { fights.Approach(l, goal) }
...
func CampBomb() Behaviour { return fights.CampBomb() }

// GuardPoint is CTFBotGuardPoint.
//
//sp:body CTFBotGuardPoint
func GuardPoint() Behaviour { return fights.GuardPoint() }

// DestroyTeleporter is CTFBotDestroyTeleporter.
//
//sp:body CTFBotDestroyTeleporter
func DestroyTeleporter() Behaviour { return fights.DestroyTeleporter() }

// CollectMoney is CTFBotCollectMoney.
//
//sp:body CTFBotCollectMoney
func CollectMoney() Behaviour { return fights.CollectMoney() }

// GuardPointIsPossible is that one's.
//
//sp:body CTFBotGuardPoint_IsPossible
func GuardPointIsPossible(client int32) bool { return fights.GuardPointIsPossible(client) }

// CollectMoneyIsPossible is that one's.
//
//sp:body CTFBotCollectMoney_IsPossible
func CollectMoneyIsPossible(client int32) bool { return fights.CollectMoneyIsPossible(client) }
