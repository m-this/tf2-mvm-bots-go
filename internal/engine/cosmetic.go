...
func ItemList() List {
	if cosmetics.ItemList == nil {
		missing("TF2Econ_GetItemList")
	}
	return cosmetics.ItemList()
}
...
func ItemLoadoutSlot(itemDefinition int32, playerClass Class) int32 {
	if cosmetics.ItemLoadoutSlot == nil {
		missing("TF2Econ_GetItemLoadoutSlot")
	}
...
func ItemDefinitionString(itemDefinition int32, key string) (found bool, out Text) {
	if cosmetics.ItemDefinitionString == nil {
		missing("TF2Econ_GetItemDefinitionString")
	}
...
func ItemDefinitionStringInto(itemDefinition int32, key Text, out Text, maxlength int32) bool {
	if cosmetics.ItemDefinitionStringInto == nil {
		missing("TF2Econ_GetItemDefinitionString")
	}
...
func ItemDefinitionStringKeyInto(itemDefinition int32, key string, out Text, maxlength int32) bool {
	if cosmetics.ItemDefinitionStringKeyInto == nil {
		missing("TF2Econ_GetItemDefinitionString")
	}
...
func ItemDefinitionStringAt(itemDefinition int32, key Text) (found bool, out Text) {
	if cosmetics.ItemDefinitionStringAt == nil {
		missing("TF2Econ_GetItemDefinitionString")
	}
...
func ItemClassName(itemDefinition int32) (found bool, out Text) {
	if cosmetics.ItemClassName == nil {
		missing("TF2Econ_GetItemClassName")
	}
...
func LoadoutSlotNameToIndex(name string) int32 {
	if cosmetics.LoadoutSlotNameToIndex == nil {
		missing("TF2Econ_TranslateLoadoutSlotNameToIndex")
	}
	return cosmetics.LoadoutSlotNameToIndex(name)
}

// ParticleAttributeList is every effect in that set. The caller owns it.
//
//sp:native TF2Econ_GetParticleAttributeList
func ParticleAttributeList(set ParticleSet) List {
	if cosmetics.ParticleAttributeList == nil {
		missing("TF2Econ_GetParticleAttributeList")
	}
	return cosmetics.ParticleAttributeList(set)
}
...
func SetAttributeByDefIndex(entity int32, attribute int32, value float32) {
	if cosmetics.SetAttributeByDefIndex == nil {
		missing("TF2Attrib_SetByDefIndex")
	}
...
func SetWearableAlwaysValid(wearable int32, valid bool) {
	if cosmetics.SetWearableAlwaysValid == nil {
		missing("TF2Util_SetWearableAlwaysValid")
	}
...
func RemoveWearable(client int32, wearable int32) {
	if cosmetics.RemoveWearable == nil {
		missing("TF2_RemoveWearable")
	}
	cosmetics.RemoveWearable(client, wearable)
}

// SetEntityModel gives the entity a shape.
//
//sp:native SetEntityModel
func SetEntityModel(entity int32, model Text) {
	if cosmetics.SetEntityModel == nil {
		missing("SetEntityModel")
	}
	cosmetics.SetEntityModel(entity, model)
}

// RemoveEntity deletes it.
//
//sp:native RemoveEntity
func RemoveEntity(entity int32) {
	if cosmetics.RemoveEntity == nil {
		missing("RemoveEntity")
	}
	cosmetics.RemoveEntity(entity)
}

// IsModelPrecached says the map already loaded that model.
//
//sp:native IsModelPrecached
func IsModelPrecached(model Text) bool {
	if cosmetics.IsModelPrecached == nil {
		missing("IsModelPrecached")
	}
	return cosmetics.IsModelPrecached(model)
}
...
func PrecacheModel(model Text) int32 {
	if cosmetics.PrecacheModel == nil {
		missing("PrecacheModel")
	}
	return cosmetics.PrecacheModel(model)
}

// Erase takes the entry at that index out and moves the rest down.
//
//sp:method Erase
func (l List) Erase(index int32) {
	if cosmetics.ListErase == nil {
		missing("ArrayList.Erase")
	}
	cosmetics.ListErase(l, index)
}

// FindValue is where that value is, or -1.
//
//sp:method FindValue
func (l List) FindValue(value int32) int32 {
	if cosmetics.ListFindValue == nil {
		missing("ArrayList.FindValue")
	}
	return cosmetics.ListFindValue(l, value)
}
