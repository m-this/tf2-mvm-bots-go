...
stock int Go_nearestObject(float origin[3], int myTeam, float maxDistance, const char[] classname, Go_ObjectKind kind)
{
...
stock bool Go_objectWanted(Go_ObjectKind kind, int ent, int myTeam)
{
	switch (kind)
	{
...
stock int Go_nearestClient(int client, float origin[3], float maxDistance, Go_Kind kind, bool farthest, bool giantsOnly, bool ignoreUber, bool stunnedOnly, TFClassType class, float speedCheck)
{
...
stock bool Go_wantedBy(Go_Kind kind, int i, bool giantsOnly, bool ignoreUber, bool stunnedOnly, TFClassType class, float speedCheck)
{
	switch (kind)
	{
		case Go_KindEnemy:
